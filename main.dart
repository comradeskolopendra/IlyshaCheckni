        ...
        children: [
          Container(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                child: Text('Нажмите сюда для регистрации пользователя'),
          ...
          Container(
            ...
            child: SizedBox(
              width: 400.0,
              child: ElevatedButton(
                child: Text('Нажмите сюда для авторизации'),
          ...
          Container(
            ...
            child: SizedBox( 
              width: 400.0,
              child: ElevatedButton(
                child: Text('Смена пароля от вашего аккаунта'),
